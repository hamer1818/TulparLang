...
static void register_builtin_signatures(TypeInferContext *ctx) {
  ...
  const BuiltinSig sigs[] = {
      ...
      {"tm_time", TYPE_FLOAT, {}},
      {"tm_width", TYPE_INT, {}},
      {"tm_window_resizable", TYPE_VOID, {TYPE_INT}},
      {"tm_fullscreen", TYPE_VOID, {TYPE_INT}},
      {"tm_is_fullscreen", TYPE_BOOL, {}},
      {"tm_maximize", TYPE_VOID, {TYPE_INT}},
      {"tm_window_resized", TYPE_BOOL, {}},
      {"tm_height", TYPE_INT, {}},
