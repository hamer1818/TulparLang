public class nbody {
    ...
    static final double DPY = 365.24;
    ...
    public static void main(String[] args) {
        int n = 1000000;
        String s = System.getenv("BENCH_N");
        if (s != null) { try { int v = Integer.parseInt(s); if (v > 0) n = v; } catch (Exception ex) {} }
        ...
        System.out.println((long) Math.round(energy() * 1e9));
    }
}
