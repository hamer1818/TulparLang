...
**Run:** `2026-05-13T15:26:27Z` UTC · commit `0e1935e` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 110× slower |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 36× slower |
