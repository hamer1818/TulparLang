...
**Run:** `2026-05-13T11:44:59Z` UTC · commit `ed42ab8` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 3.
...
| Go | 4.6 | 59.5 |
| Node.js | 39.4 | 140.8 |
| Python | 1064.1 | 1264.5 |
| Rust (-O3) | 0.9 | 32.4 |
| **Tulpar AOT (LLVM)** | 2.0 | 33.7 |
| **Tulpar VM** | 160.5 | 591.3 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 2.86× of C | **19.7× faster** | **532× faster** |
| fib | 1.98× of C | **4.2× faster** | **38× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 125× slower |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 41× slower |
