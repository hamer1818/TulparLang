...
**Run:** `2026-05-11T09:30:55Z` UTC · commit `b541fdb` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 5.
...
| Go | 4.6 | 57.5 |
| Node.js | 40.2 | 143.1 |
| Python | 1043.4 | 1258.8 |
| Rust (-O3) | 0.8 | 32.6 |
| **Tulpar AOT (LLVM)** | 1.9 | 32.2 |
| **Tulpar VM** | 161.2 | 590.9 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.17× of C | **21.2× faster** | **549× faster** |
