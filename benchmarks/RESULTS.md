...
**Run:** `2026-05-11T20:43:53Z` UTC · commit `de18b1e` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 5.
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 103× slower |
