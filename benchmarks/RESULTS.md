...
**Run:** `2026-05-12T19:21:58Z` UTC · commit `c484db1` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python | 854.1 | 1212.3 |
| Rust (-O3) | 0.8 | 29.3 |
| **Tulpar AOT (LLVM)** | 1.9 | 29.0 |
| **Tulpar VM** | 149.9 | 526.4 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 2.71× of C | **20.1× faster** | **450× faster** |
| fib | 1.57× of C | **4.7× faster** | **42× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 107× slower |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 35× slower |
