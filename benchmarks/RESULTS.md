...
**Run:** `2026-05-13T10:43:14Z` UTC · commit `455fb42` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 106× slower |
