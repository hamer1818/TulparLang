...
**Run:** `2026-05-12T18:02:04Z` UTC · commit `e8f53f2` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 97× slower |
