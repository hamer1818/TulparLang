...
**Run:** `2026-05-11T14:46:27Z` UTC · commit `c73fcb3` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 5.
...
| Python | 844.7 | 1216.6 |
| Rust (-O3) | 0.8 | 29.2 |
| **Tulpar AOT (LLVM)** | 1.8 | 28.1 |
| **Tulpar VM** | 162.9 | 525.8 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **20.4× faster** | **469× faster** |
| fib | 1.56× of C | **4.7× faster** | **43× faster** |
