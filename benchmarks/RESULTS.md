...
**Run:** `2026-05-10T09:21:15Z` UTC · commit `39d14e1` · runner `Linux` `Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz` · best of 5.
...
|---|---:|---:|
| **Tulpar listen_evented** | 27627 | 0.109 |
| **Tulpar listen** | 26651 | 0.113 |
| Node.js http | 14412 | 0.208 |
| Python ThreadingHTTP | 98 | 30.697 |
