...
**Run:** `2026-05-11T21:28:49Z` UTC · commit `9ed2659` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 5.
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 111× slower |
