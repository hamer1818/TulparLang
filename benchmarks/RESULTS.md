...
**Run:** `2026-05-12T21:18:57Z` UTC · commit `a949172` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 3.
...
| Python | 970.7 | 1260.0 |
| Rust (-O3) | 0.8 | 32.4 |
| **Tulpar AOT (LLVM)** | 1.9 | 29.6 |
| **Tulpar VM** | 183.8 | 595.9 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.17× of C | **21.1× faster** | **511× faster** |
| fib | 1.74× of C | **4.8× faster** | **43× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 119× slower |
