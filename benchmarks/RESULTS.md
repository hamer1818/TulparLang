...
**Run:** `2026-05-12T20:58:42Z` UTC · commit `b2f2260` · runner `Linux` `Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz` · best of 3.
...
| Python | 820.5 | 1154.1 |
| Rust (-O3) | 0.6 | 25.5 |
| **Tulpar AOT (LLVM)** | 1.7 | 27.6 |
| **Tulpar VM** | 164.5 | 465.4 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.4× of C | **24.6× faster** | **483× faster** |
| fib | 1.71× of C | **4.5× faster** | **42× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 153× slower |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 56× slower |
