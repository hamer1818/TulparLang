...
**Run:** `2026-05-11T22:38:54Z` UTC · commit `2c3d95a` · runner `Linux` `Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz` · best of 3.
...
| Python | 825.6 | 1147.4 |
| Rust (-O3) | 0.6 | 25.7 |
| **Tulpar AOT (LLVM)** | 1.5 | 27.7 |
| **Tulpar VM** | 157.5 | 464.6 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **26.1× faster** | **550× faster** |
| fib | 1.69× of C | **4.4× faster** | **41× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 55× slower |
