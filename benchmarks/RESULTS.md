...
**Run:** `2026-05-12T17:02:28Z` UTC · commit `44db543` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python | 859.2 | 1232.6 |
| Rust (-O3) | 0.8 | 29.1 |
| **Tulpar AOT (LLVM)** | 1.9 | 28.7 |
| **Tulpar VM** | 149.2 | 556.1 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.17× of C | **19.8× faster** | **452× faster** |
| fib | 1.59× of C | **4.6× faster** | **43× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 99× slower |
