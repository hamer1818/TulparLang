...
**Run:** `2026-05-12T16:09:50Z` UTC · commit `2fb806a` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python | 845.1 | 1212.1 |
| Rust (-O3) | 0.8 | 29.1 |
| **Tulpar AOT (LLVM)** | 1.8 | 28.5 |
| **Tulpar VM** | 150.1 | 528.9 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **21.1× faster** | **470× faster** |
| fib | 1.57× of C | **4.6× faster** | **43× faster** |
