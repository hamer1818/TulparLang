...
**Run:** `2026-05-12T21:27:23Z` UTC · commit `f5cd327` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 3.
...
| Python | 840.9 | 976.5 |
| Rust (-O3) | 0.7 | 25.1 |
| **Tulpar AOT (LLVM)** | 1.5 | 22.9 |
| **Tulpar VM** | 118.5 | 458.7 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **20.6× faster** | **561× faster** |
| fib | 1.73× of C | **4.8× faster** | **43× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 53× slower |
