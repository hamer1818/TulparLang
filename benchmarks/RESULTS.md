...
**Run:** `2026-05-13T12:16:43Z` UTC · commit `7915e23` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 3.
...
| Python | 856.2 | 1261.2 |
| Rust (-O3) | 0.8 | 32.4 |
| **Tulpar AOT (LLVM)** | 2.1 | 29.8 |
| **Tulpar VM** | 165.7 | 592.0 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **19.4× faster** | **408× faster** |
| fib | 1.74× of C | **4.8× faster** | **42× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 114× slower |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 42× slower |
