...
**Run:** `2026-05-11T22:03:42Z` UTC · commit `5a0dc9e` · runner `Linux` `Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz` · best of 3.
...
| Python | 856.1 | 1150.1 |
| Rust (-O3) | 0.6 | 25.7 |
| **Tulpar AOT (LLVM)** | 1.5 | 27.4 |
| **Tulpar VM** | 157.9 | 464.1 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **26.4× faster** | **571× faster** |
| fib | 1.7× of C | **4.4× faster** | **42× faster** |
