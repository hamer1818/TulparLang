...
**Run:** `2026-05-13T11:51:45Z` UTC · commit `e78f733` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python | 852.8 | 1220.0 |
| Rust (-O3) | 0.8 | 28.9 |
| **Tulpar AOT (LLVM)** | 1.8 | 30.3 |
| **Tulpar VM** | 149.6 | 528.5 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **21.2× faster** | **474× faster** |
| fib | 1.68× of C | **4.5× faster** | **40× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 100× slower |
