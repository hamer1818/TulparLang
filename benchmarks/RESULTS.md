...
**Run:** `2026-05-12T19:49:06Z` UTC · commit `4d66c1a` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python | 869.1 | 1219.1 |
| Rust (-O3) | 0.8 | 29.2 |
| **Tulpar AOT (LLVM)** | 1.8 | 28.7 |
| **Tulpar VM** | 150.1 | 526.4 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 2.57× of C | **20.9× faster** | **483× faster** |
| fib | 1.6× of C | **4.6× faster** | **42× faster** |
