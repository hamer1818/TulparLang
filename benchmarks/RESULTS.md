...
**Run:** `2026-05-13T12:46:17Z` UTC · commit `5e3529d` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python | 840.5 | 1216.9 |
| Rust (-O3) | 0.8 | 29.0 |
| **Tulpar AOT (LLVM)** | 1.8 | 30.5 |
| **Tulpar VM** | 142.9 | 520.9 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **20.3× faster** | **467× faster** |
| fib | 1.66× of C | **4.4× faster** | **40× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 102× slower |
