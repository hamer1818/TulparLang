...
**Run:** `2026-05-13T12:59:06Z` UTC · commit `c357174` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python | 848.3 | 1215.3 |
| Rust (-O3) | 0.8 | 29.2 |
| **Tulpar AOT (LLVM)** | 1.8 | 30.7 |
| **Tulpar VM** | 144.2 | 521.5 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **21.3× faster** | **471× faster** |
| fib | 1.69× of C | **4.3× faster** | **40× faster** |
