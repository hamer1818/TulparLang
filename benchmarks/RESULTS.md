...
> _This block is auto-generated by [`benchmarks/ci_run.py`](ci_run.py)
> on every push to `main`. Do not hand-edit — your changes will be
> overwritten by the next CI run. Prose context below the `BENCH:RESULTS END`
> marker is preserved verbatim._

**Run:** `2026-05-07T12:27:00Z` UTC · commit `pre-CI` (seed values from
the last manual run on a Windows dev box; CI will refresh on first push
to `main`) · best of 5.
...
|---|---:|---:|
| loopsum | 1.53× | 1.5× faster |
| fib | 1.76× | 1.92× faster |
...
|---|---:|---:|
| **Tulpar listen_async** | 34095 | 0.088 |
| **Tulpar listen_pool x8** | 33026 | 0.091 |
| **Tulpar listen_evented** | 31032 | 0.097 |
| **Tulpar listen** | 18207 | 0.165 |
| Node.js http | 17805 | 0.169 |
| Python ThreadingHTTP | 11717 | 0.256 |
