...
**Run:** `2026-05-12T17:41:45Z` UTC · commit `ba5492f` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python | 862.6 | 1217.5 |
| Rust (-O3) | 0.8 | 28.9 |
| **Tulpar AOT (LLVM)** | 1.8 | 28.3 |
| **Tulpar VM** | 154.1 | 529.6 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **20.2× faster** | **479× faster** |
| fib | 1.55× of C | **4.6× faster** | **43× faster** |
