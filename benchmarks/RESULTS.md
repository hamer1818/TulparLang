...
**Run:** `2026-05-10T22:00:48Z` UTC · commit `f8ebc2a` · runner `Linux` `Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz` · best of 5.
...
|---|---:|---:|
| **Tulpar listen_evented** | 24940 | 0.12 |
| **Tulpar listen** | 24914 | 0.12 |
| Node.js http | 14386 | 0.209 |
| Python ThreadingHTTP | 98 | 30.695 |
