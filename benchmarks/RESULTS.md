...
**Run:** `2026-05-12T15:35:12Z` UTC · commit `cb14a13` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 3.
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 129× slower |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 40× slower |
