...
**Run:** `2026-05-12T18:45:39Z` UTC · commit `09a61c1` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 3.
...
| Python | 914.8 | 1264.3 |
| Rust (-O3) | 0.8 | 32.4 |
| **Tulpar AOT (LLVM)** | 2.0 | 32.1 |
| **Tulpar VM** | 150.9 | 585.8 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 2.86× of C | **20.2× faster** | **457× faster** |
| fib | 1.89× of C | **4.4× faster** | **39× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 124× slower |
