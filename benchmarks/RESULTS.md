...
**Run:** `2026-05-11T22:29:23Z` UTC · commit `ecfbd0f` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 3.
...
| Go | 4.7 | 57.3 |
| Node.js | 40.8 | 142.4 |
| Python | 1103.4 | 1258.1 |
| Rust (-O3) | 0.9 | 32.4 |
| **Tulpar AOT (LLVM)** | 2.0 | 32.3 |
| **Tulpar VM** | 153.3 | 588.3 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.33× of C | **20.4× faster** | **552× faster** |
| fib | 1.9× of C | **4.4× faster** | **39× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 108× slower |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 43× slower |
