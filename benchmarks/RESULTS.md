...
**Run:** `2026-05-12T16:01:31Z` UTC · commit `8a83065` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 3.
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 127× slower |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 46× slower |
