...
**Run:** `2026-05-10T21:46:13Z` UTC · commit `c6ea0b2` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 5.
...
| **Tulpar VM** | 149.8 | 529.8 |

**Ratios (Tulpar AOT vs reference):**

| Benchmark | × C (gcc -O2) | × Node.js |
|---|---:|---:|
| loopsum | 3.0× | 21.44× faster |
| fib | 1.57× | 4.56× faster |
...
|---|---:|---:|
| **Tulpar listen_evented** | 16180 | 0.185 |
| **Tulpar listen** | 15157 | 0.198 |
| Node.js http | 9386 | 0.32 |
