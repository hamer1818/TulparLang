...
**Run:** `2026-05-12T18:09:26Z` UTC · commit `bd70127` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 3.
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 38× slower |
