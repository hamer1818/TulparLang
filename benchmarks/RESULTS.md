...
**Run:** `2026-05-12T19:30:46Z` UTC · commit `625dc41` · runner `Linux` `Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz` · best of 3.
...
| Python | 829.2 | 1147.6 |
| Rust (-O3) | 0.6 | 25.6 |
| **Tulpar AOT (LLVM)** | 1.5 | 27.5 |
| **Tulpar VM** | 156.9 | 465.1 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **26.5× faster** | **553× faster** |
| fib | 1.71× of C | **4.4× faster** | **42× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 142× slower |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 59× slower |
