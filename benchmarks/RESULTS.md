...
**Run:** `2026-05-10T22:13:01Z` UTC · commit `de75f6a` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 5.
...
| Go | 4.6 | 59.5 |
| Node.js | 38.9 | 140.8 |
| Python | 1032.2 | 1264.1 |
| Rust (-O3) | 0.8 | 32.4 |
| **Tulpar AOT (LLVM)** | 2.0 | 31.6 |
| **Tulpar VM** | 159.1 | 591.8 |

**Ratios (Tulpar AOT vs reference):**

| Benchmark | × C (gcc -O2) | × Node.js |
|---|---:|---:|
| loopsum | 3.33× | 19.45× faster |
| fib | 1.85× | 4.46× faster |
...
|---|---:|---:|
| **Tulpar listen_evented** | 27751 | 0.108 |
| **Tulpar listen** | 22397 | 0.134 |
| Node.js http | 11376 | 0.264 |
| Python ThreadingHTTP | 98 | 30.675 |
