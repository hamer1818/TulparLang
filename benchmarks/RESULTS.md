...
**Run:** `2026-05-13T14:21:08Z` UTC · commit `80ed39b` · runner `Linux` `Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz` · best of 3.
...
| Python | 853.0 | 1146.1 |
| Rust (-O3) | 0.6 | 25.4 |
| **Tulpar AOT (LLVM)** | 1.5 | 26.2 |
| **Tulpar VM** | 160.6 | 467.6 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **25.0× faster** | **569× faster** |
| fib | 1.66× of C | **4.6× faster** | **44× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 156× slower |
