...
**Run:** `2026-05-12T18:34:52Z` UTC · commit `315c5e3` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 3.
...
| Go | 4.7 | 57.8 |
| Node.js | 40.4 | 142.0 |
| Python | 1068.8 | 1258.1 |
| Rust (-O3) | 0.8 | 32.4 |
| **Tulpar AOT (LLVM)** | 2.3 | 31.6 |
| **Tulpar VM** | 164.0 | 591.4 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.29× of C | **17.6× faster** | **465× faster** |
| fib | 1.85× of C | **4.5× faster** | **40× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 117× slower |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 39× slower |
