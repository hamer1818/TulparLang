...
**Run:** `2026-05-13T12:25:32Z` UTC · commit `b20b8ae` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 34× slower |
