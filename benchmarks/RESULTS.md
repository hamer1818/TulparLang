...
**Run:** `2026-05-11T21:39:18Z` UTC · commit `8af5895` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 5.
...
| Python | 851.9 | 1206.3 |
| Rust (-O3) | 0.8 | 29.2 |
| **Tulpar AOT (LLVM)** | 1.8 | 29.0 |
| **Tulpar VM** | 143.3 | 526.1 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **21.1× faster** | **473× faster** |
| fib | 1.58× of C | **4.5× faster** | **42× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 37× slower |
