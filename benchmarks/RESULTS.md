...
**Run:** `2026-05-13T14:12:06Z` UTC · commit `c0f8585` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 3.
...
| Python | 918.0 | 1262.7 |
| Rust (-O3) | 0.8 | 32.6 |
| **Tulpar AOT (LLVM)** | 2.0 | 34.2 |
| **Tulpar VM** | 150.4 | 577.9 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 2.86× of C | **21.2× faster** | **459× faster** |
| fib | 1.99× of C | **4.2× faster** | **37× faster** |
