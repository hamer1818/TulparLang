...
**Run:** `2026-05-13T13:12:57Z` UTC · commit `0551703` · runner `Linux` `Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz` · best of 3.
...
| Python | 806.4 | 1146.0 |
| Rust (-O3) | 0.6 | 25.6 |
| **Tulpar AOT (LLVM)** | 1.4 | 26.5 |
| **Tulpar VM** | 159.3 | 468.4 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 2.8× of C | **28.4× faster** | **576× faster** |
| fib | 1.64× of C | **4.6× faster** | **43× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 165× slower |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 58× slower |
