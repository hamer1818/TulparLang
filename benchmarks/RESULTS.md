...
**Run:** `2026-05-12T22:31:05Z` UTC · commit `fc76dc1` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 3.
...
| Go | 4.6 | 59.5 |
| Node.js | 40.7 | 141.3 |
| Python | 1109.6 | 1255.6 |
| Rust (-O3) | 0.8 | 32.3 |
| **Tulpar AOT (LLVM)** | 1.9 | 33.6 |
| **Tulpar VM** | 164.8 | 588.9 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.17× of C | **21.4× faster** | **584× faster** |
| fib | 1.96× of C | **4.2× faster** | **37× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 391 | 44× slower |
