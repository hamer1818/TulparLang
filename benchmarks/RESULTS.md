...
**Run:** `2026-05-11T21:05:11Z` UTC · commit `80455b6` · runner `Linux` `AMD EPYC 9V74 80-Core Processor` · best of 5.
...
| Go | 4.6 | 57.5 |
| Node.js | 39.9 | 141.4 |
| Python | 1004.1 | 1255.9 |
| Rust (-O3) | 0.8 | 32.3 |
| **Tulpar AOT (LLVM)** | 1.9 | 31.7 |
| **Tulpar VM** | 152.5 | 591.9 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.17× of C | **21.0× faster** | **528× faster** |
| fib | 1.86× of C | **4.5× faster** | **40× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 135× slower |
...
| **Tulpar listen_evented** | single thread, poll()-multiplexed | 17 712 | 1× slower |
| Python ThreadingHTTP | OS thread spawned per request | 391 | 47× slower |
