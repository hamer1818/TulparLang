...
**Run:** `2026-05-10T22:34:29Z` UTC · commit `c69fcfa` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 5.
...
| Python | 865.2 | 1214.5 |
| Rust (-O3) | 0.8 | 29.4 |
| **Tulpar AOT (LLVM)** | 2.2 | 29.0 |
| **Tulpar VM** | 150.5 | 529.6 |

**Ratios (Tulpar AOT vs reference):**

| Benchmark | × C (gcc -O2) | × Node.js |
|---|---:|---:|
| loopsum | 3.67× | 18.27× faster |
| fib | 1.56× | 4.58× faster |
...
|---|---:|---:|
| **Tulpar listen** | 17444 | 0.172 |
| **Tulpar listen_evented** | 16305 | 0.184 |
| **Tulpar listen_pool x8** | 15806 | 0.19 |
| **Tulpar listen_async** | 15618 | 0.192 |
| Node.js http | 9358 | 0.321 |
| Python ThreadingHTTP | 98 | 30.677 |
