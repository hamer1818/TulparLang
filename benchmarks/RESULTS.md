...
**Run:** `2026-05-12T18:58:13Z` UTC · commit `5a09c4b` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python | 862.7 | 1199.6 |
| Rust (-O3) | 0.8 | 28.8 |
| **Tulpar AOT (LLVM)** | 1.8 | 27.0 |
| **Tulpar VM** | 148.6 | 507.3 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 3.0× of C | **20.6× faster** | **479× faster** |
| fib | 1.54× of C | **4.7× faster** | **44× faster** |
