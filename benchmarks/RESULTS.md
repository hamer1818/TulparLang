...
**Run:** `2026-05-11T22:50:46Z` UTC · commit `8adec09` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 109× slower |
