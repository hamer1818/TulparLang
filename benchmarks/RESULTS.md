...
**Run:** `2026-05-12T20:06:47Z` UTC · commit `ecec0ea` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 101× slower |
