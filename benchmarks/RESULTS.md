...
**Run:** `2026-05-12T18:26:04Z` UTC · commit `4a857cb` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python | 867.3 | 1213.2 |
| Rust (-O3) | 0.8 | 29.3 |
| **Tulpar AOT (LLVM)** | 1.9 | 28.9 |
| **Tulpar VM** | 147.8 | 524.2 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 2.71× of C | **19.9× faster** | **456× faster** |
| fib | 1.57× of C | **4.6× faster** | **42× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 94× slower |
