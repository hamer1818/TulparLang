...
**Run:** `2026-05-10T08:01:01Z` UTC · commit `972bf1e` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 5.
...
| **Tulpar VM** | 147.6 | 524.0 |

**Ratios (Tulpar AOT vs reference):**

| Benchmark | × C (gcc -O2) | × Node.js |
|---|---:|---:|
| loopsum | 3.0× | 20.56× faster |
| fib | 1.59× | 4.58× faster |
...
|---|---:|---:|
| **Tulpar listen_evented** | 17845 | 0.168 |
| **Tulpar listen** | 14566 | 0.206 |
| Node.js http | 10461 | 0.287 |
| Python ThreadingHTTP | 98 | 30.685 |
