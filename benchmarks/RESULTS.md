...
**Run:** `2026-05-13T14:01:09Z` UTC · commit `234c633` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 3.
...
| Python | 841.0 | 1216.9 |
| Rust (-O3) | 0.8 | 29.0 |
| **Tulpar AOT (LLVM)** | 1.8 | 30.1 |
| **Tulpar VM** | 142.3 | 522.9 |

**Speed ratios** — how Tulpar AOT compares to each reference language:

| Workload | vs C (gcc -O2) | vs Node.js | vs Python |
|---|---:|---:|---:|
| loopsum | 2.57× of C | **20.0× faster** | **467× faster** |
| fib | 1.64× of C | **4.3× faster** | **40× faster** |
...
| Python ThreadingHTTP | OS thread spawned per request | 98 | 104× slower |
