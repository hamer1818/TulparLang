...
**Run:** `2026-05-10T10:49:30Z` UTC · commit `40e672f` · runner `Linux` `AMD EPYC 7763 64-Core Processor` · best of 5.
...
| Python | 831.2 | 1218.4 |
| Rust (-O3) | 0.8 | 29.5 |
| **Tulpar AOT (LLVM)** | 1.8 | 28.8 |
| **Tulpar VM** | 149.2 | 528.8 |

**Ratios (Tulpar AOT vs reference):**

| Benchmark | × C (gcc -O2) | × Node.js |
|---|---:|---:|
| loopsum | 3.0× | 20.17× faster |
| fib | 1.57× | 4.61× faster |
...
|---|---:|---:|
| **Tulpar listen_evented** | 17412 | 0.172 |
| **Tulpar listen** | 17302 | 0.173 |
| Node.js http | 10714 | 0.28 |
| Python ThreadingHTTP | 98 | 30.687 |
