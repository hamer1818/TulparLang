...
Tulpar AOT lands at **1.53–1.76× C (gcc -O2)** on these microbenchmarks
— same neighbourhood as Go, faster than Node, an order of magnitude
ahead of Python.
<!-- BENCH:CPU_TABLE END -->
...
Tulpar's `listen_async` serves **1.91× the throughput of Node.js'
