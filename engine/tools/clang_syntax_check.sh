...
FLAGS="-std=c++17 -fsyntax-only -fno-exceptions -fno-rtti -Wall -Wextra -DENGINE_MEM_CANARY=1 -DENGINE_SOURCE_DIR=\"engine\" -DPHYSICS_GOLDEN_HASH=0ull -DJPH_CROSS_PLATFORM_DETERMINISTIC -Iengine -Iengine/third_party/vulkan -Iengine/third_party/jolt -Iengine/third_party/recast/Recast/Include -Iengine/third_party/recast/Detour/Include -Iengine/third_party/glfw -Iengine/third_party/cgltf -Iengine/third_party/stb"
