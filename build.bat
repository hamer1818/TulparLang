...
:copy_exe
echo.
echo Copying executable and runtime library...
if exist tulpar.exe copy /Y tulpar.exe ..\tulpar.exe >nul
if exist Release\tulpar.exe copy /Y Release\tulpar.exe ..\tulpar.exe >nul
if exist libtulpar_runtime.a copy /Y libtulpar_runtime.a ..\libtulpar_runtime.a >nul
if exist Release\tulpar_runtime.lib copy /Y Release\tulpar_runtime.lib ..\tulpar_runtime.lib >nul
cd ..
