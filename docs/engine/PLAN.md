...
> ⚠️ REV: **Her AL bir hipotezdir** — cihaz matrisinde (bir Mali, bir Adreno, bir düşük segment; `docs/engine/CIHAZ-MATRISI.md`) ölçülüp doğrulanana kadar. Bu tablodaki kararlar okumadan geldi, ölçümden değil; belge bunu yer yer söylüyordu ("prototiple ve ölç"), şimdi kural. Emülatör TBDR değildir, ölçüm sayılmaz.
...
> ⚠️ REV: bu tablolardaki her rakam **[hedef]**; cihaz matrisi belgesiyle (`docs/engine/CIHAZ-MATRISI.md`) kalibre edilir, cihazda ölçülene kadar bütçe değil tahmin.
...
### Faz 0 — Ölçüm ve Temel ✅ (kapatıldı 2026-09-14 — durum ve ölçümler: `docs/engine/FAZ0.md`)
...
- Crash reporter + sembol çözümleme: sinyal işleyici (alternatif yığın), build id, modül+ofset; `engine/tools/symbolize.py`
