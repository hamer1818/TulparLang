...
## 8. Motor tuzakları — **ayrı depoda**

Motorun C++ çekirdeğine ait tuzaklar (8a–8ap) 2026-09-20'de motorla birlikte
[tulpar-engine](https://github.com/hamer1818/tulpar-engine) deposuna taşındı: orada `docs/TUZAKLAR.md`.
Numaralandırma korundu, yani eski "Tuzaklar 8q" / "Tuzaklar 8ap" atıfları
orada aynı adla duruyor. Bu dosya artık yalnız **dilin** tuzaklarını
(1–7. bölümler) tutuyor.
